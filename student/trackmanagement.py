...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        # initial position estimation error covariance
        P_pos = M_rot * meas.R * M_rot.transpose()

        # initial velocity estimation error covariance
        sigma_p44 = params.sigma_p44 ** 2  # vx
        sigma_p55 = params.sigma_p55 ** 2  # vy
        sigma_p66 = params.sigma_p66 ** 2  # vz
        P_vel = np.matrix([[sigma_p44, 0, 0],
                           [0, sigma_p55, 0],
                           [0, 0, sigma_p66]])
        ...
        # set state and give initial confidence score
    ...
    def update_attributes(self, meas):
        ...
        # print("Updated attributes. New meas is:", meas)
...
class Trackmanagement:
    ...
    def handle_updated_track(self, track):
        ...
        print('Track state is currently:', track.state)
